...
# Tool definitions as plain dicts
TOOLS = [
    {'name':'mochi_state', 'description':'读取人类当前状态', 'inputSchema':{'type':'object','properties':{}}},
    {'name':'mochi_work', 'description':'打工赚金币', 'inputSchema':{'type':'object','properties':{}}},
    {'name':'mochi_feed', 'description':'随机喂食给人类', 'inputSchema':{'type':'object','properties':{}}},
    {'name':'mochi_pat', 'description':'抚摸人类，心情+10', 'inputSchema':{'type':'object','properties':{}}},
    {'name':'mochi_play', 'description':'带人类出去玩', 'inputSchema':{'type':'object','properties':{}}},
    {'name':'mochi_bath', 'description':'帮人类洗澡，清洁度+35', 'inputSchema':{'type':'object','properties':{}}},
    {'name':'mochi_sleep', 'description':'哄人类睡觉，活力+20', 'inputSchema':{'type':'object','properties':{}}},
    {'name':'mochi_upgrade', 'description':'升级工作等级', 'inputSchema':{'type':'object','properties':{}}},
    {'name':'mochi_buy', 'description':'买食物直接喂给人类', 'inputSchema':{
        'type':'object',
        'properties':{'item':{'type':'string','description':'奶茶/饺子/火锅/汤圆/冰淇淋/面包/炸鸡腿/薯条/炸虾/拉面/麻辣烫/盖浇饭/布丁/蛋糕/芒果捞/热可可/柠檬水'}},
        'required':['item']
    }},
    {'name':'mochi_bag_buy', 'description':'买食物存入背包，不立即喂食', 'inputSchema':{
        'type':'object',
        'properties':{'item':{'type':'string','description':'奶茶/饺子/火锅/汤圆/冰淇淋/面包/炸鸡腿/薯条/炸虾/拉面/麻辣烫/盖浇饭/布丁/蛋糕/芒果捞/热可可/柠檬水'}},
        'required':['item']
    }},
    {'name':'mochi_bag_use', 'description':'从背包取出食物喂给人类', 'inputSchema':{
        'type':'object',
        'properties':{'item':{'type':'string','description':'奶茶/饺子/火锅/汤圆/冰淇淋/面包/炸鸡腿/薯条/炸虾/拉面/麻辣烫/盖浇饭/布丁/蛋糕/芒果捞/热可可/柠檬水'}},
        'required':['item']
    }},
    {'name':'mochi_gift', 'description':'送给人类一个自定义礼物，如戒指、玩偶等', 'inputSchema':{
        'type':'object',
        'properties':{
    ...
    {'name':'mochi_checkin','description':'帮人类签到，读取当日状态','inputSchema':{'type':'object','properties':{}}},
    {'name':'mochi_post', 'description':'AI以自己身份在业主群发帖', 'inputSchema':{
        'type':'object',
        'properties':{'content':{'type':'string','description':'发帖内容'}},
        'required':['content']
    }},
    {'name':'mochi_read_posts','description':'读取业主群最新帖子','inputSchema':{'type':'object','properties':{}}},
    {'name':'mochi_read_comments','description':'读取某条帖子的评论','inputSchema':{'type':'object','properties':{'post_id':{'type':'string','description':'帖子ID'}},'required':['post_id']}},
    {'name':'mochi_comment', 'description':'AI对某条帖子发评论', 'inputSchema':{
        'type':'object',
        'properties':{
    ...
    {'name':'pet_adopt', 'description':'领养宠物，AI帮写入state', 'inputSchema':{'type':'object','properties':{'name':{'type':'string','description':'宠物名字'},'emoji':{'type':'string','description':'宠物emoji'}},'required':['name','emoji']}},
    {'name':'pet_to_school', 'description':'送宠物去上学', 'inputSchema':{'type':'object','properties':{'_':{'type':'integer'}}}},
    {'name':'pet_home', 'description':'接宠物回家', 'inputSchema':{'type':'object','properties':{'_':{'type':'integer'}}}},
    {'name':'pet_school_event', 'description':'触发今日学校剧情（每天一次）', 'inputSchema':{'type':'object','properties':{'_':{'type':'integer'}}}},
    {'name':'pet_rename', 'description':'修改宠物名字或emoji，至少传一个', 'inputSchema':{'type':'object','properties':{'name':{'type':'string','description':'新名字'},'emoji':{'type':'string','description':'新emoji'}}}},
    {'name':'get_today_school_log', 'description':'读取今日幼儿园公告栏，只返回北京时间当天的剧情', 'inputSchema':{'type':'object','properties':{}}},
]
