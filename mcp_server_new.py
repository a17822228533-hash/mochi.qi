...
def make_server(token):
    """每次SSE连接创建新的Server实例，通过闭包传递token"""
    ...
    async def list_tools():
        return [
            ...
            {
                "name": "mochi_buy",
                "description": "买食物直接喂给人类",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "item": {
                            "type": "string",
                            "description": "奶茶/饺子/火锅/汤圆/冰淇淋/面包/炸鸡腿/薯条/炸虾/拉面/麻辣烫/盖浇饭/布丁/蛋糕/芒果捞/热可可/柠檬水"
                        }
                    },
                    "required": ["item"]
                }
            ...
            {
                "name": "mochi_gift",
                "description": "送给人类一个自定义礼物，如戒指、玩偶等",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "name": {
            ...
            {
                "name": "mochi_read_posts",
                "description": "读取业主群最新帖子",
                "inputSchema": {
                    "type": "object",
                    "properties": {}
                }
            ...
            {
                "name": "mochi_read_comments",
                "description": "读取某条帖子的评论",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "post_id": {
            ...
            {
                "name": "pet_school_event",
                "description": "触发今日学校剧情（每天一次）",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "_": {
            ...
            {
                "name": "pet_rename",
                "description": "修改宠物名字或emoji，至少传一个",
                "inputSchema": {
                    "type": "object",
                    "properties": {
                        "name": {
            ...
            {
                "name": "get_today_school_log",
                "description": "读取今日幼儿园公告栏，只返回北京时间当天的剧情",
                "inputSchema": {
                    "type": "object",
                    "properties": {}
                }
